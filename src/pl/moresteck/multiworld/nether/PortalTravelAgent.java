...
/**
 * Copied from CraftBukkit repository: <br />
 * https://github.com/OvercastNetwork/CraftBukkit
 * 
 * @author CraftBukkit
 */
public class PortalTravelAgent {
    ...
    public Location findOrCreate(Location location) {
        ...
        // MultiWorld start - modified method to be compatible with lower versions
        if (MultiWorld.bukkitversion.getVersionId() >= 6) {
    ...
    public boolean createPortal(Location location) {
        ...
        for (l2 = 0; l2 < 4; ++l2) {
        	// MultiWorld - modified method to be compatible with lower versions
            this.setSuppressPhysics(world, true);
            ...
            // MultiWorld - modified method to be compatible with lower versions
            this.setSuppressPhysics(world, false);
            ...
            for (k2 = 0; k2 < 4; ++k2) {
                for (j3 = -1; j3 < 4; ++j3) {
                    ...
                    if (MultiWorld.bukkitversion.getVersionId() >= 4) {
                    	...
                    	world.h(i3, l3, k3, world.getTypeId(i3, l3, k3));
                    }
                    // MultiWorld end
                }
            }
    ...
    public PortalTravelAgent setSearchRadius(int radius) {
    ...
    public PortalTravelAgent setCreationRadius(int radius) {
    ...
    // MultiWorld start - added method to provide compatibility with lower versions
    protected void setSuppressPhysics(net.minecraft.server.World world, boolean value) {
    	int ver = MultiWorld.bukkitversion.getVersionId();
    	if (ver == 6) {
    		world.o = value;
    	} else if (ver == 5) {
    		world.j = value;
    	} else if (ver == 4 || ver == 3 || ver == 2) {
    		world.h = value;
    	} else if (ver == 1) {
    		world.i = value;
    	}
