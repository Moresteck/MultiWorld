...
public class Lang {
	// §
	public static String prefix          = "§aMultiWorld:§f ";
	public static String prefixWrong     = "§cMultiWorld:§f ";
	...
	public static String setspawnCommand = "setspawnmw";
	public static String toggleCommand   = "togglemw";
}
